...
void main() async {
  ...
  // Preload SharedPreferences before runApp to ensure cache providers never return null
  ...
  // Override sharedPreferencesProvider with preloaded instance
  runApp(
    ProviderScope(
      overrides: [
        sharedPreferencesProvider.overrideWithValue(preloadedPrefs),
      ],
      child: const MyApp(),
    ),
  );
